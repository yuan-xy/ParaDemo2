...
public class ManipulatorHelper {
	 ...
	 */
	public static void save(CompilationUnit unit, IPath path,
	 ...
	 */
	public static void saveDirectlyModifiedUnit(final CompilationUnit unit,IPath path)
			throws CoreException {
		save(unit, path, new TextEditProvider() {
	...
	public static void saveASTRewriteContents(CompilationUnit unit,
			final ASTRewrite rewrite, IPath path) throws CoreException {
		save(unit, path,new TextEditProvider() {
			public TextEdit getTextEdit(IDocument document) {
